...
| 0:17 | Point at the worker's line | "He asks for a date instead. In August 2025 ASIC penalised NAB and AFSH Nominees $15.5 million — 345 customers gave notice, and never got an answer in time." ✅ laural’s wording, folded in 14 Sep: it was NAB **and AFSH Nominees**, **345 customers** not 345 notices, and they failed to respond within the required period — some received nothing at all | "So when do you think you could pay the full amount?" — measured **0:15.2**, and it really is line 7 |
